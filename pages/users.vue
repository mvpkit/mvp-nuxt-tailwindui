        ...
        >
          ...
          <div class="mt-6 flex space-x-3 md:mt-0 md:ml-4">
            ...
            <!-- <span class="shadow-sm rounded-md">
              <button
                type="button"
                class="inline-flex items-center px-4 py-2 border border-transparent text-sm leading-5 font-medium rounded-md text-white bg-red-600 hover:bg-red-500 focus:outline-none focus:shadow-outline-teal focus:border-red-700 active:bg-red-700 transition duration-150 ease-in-out"
              >
                Delete
              </button>
            </span> -->
