<template>
  <div class="h-screen flex overflow-hidden bg-white">
    ...
    <div class="lg:hidden">
      <div v-show="sideToggle" class="fixed inset-0 flex z-40">
        <!--
        ...
        >
          <div v-show="sideToggle" @click="sideToggle = !sideToggle" class="fixed inset-0">
        ...
        >
          <div v-show="sideToggle" class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-white">
            <div class="absolute top-0 right-0 -mr-14 p-1">
              <button @click="sideToggle = !sideToggle" class="flex items-center justify-center h-12 w-12 rounded-full focus:outline-none focus:bg-gray-600" aria-label="Close sidebar">
      ...
      <div class="flex flex-col w-64 border-r border-gray-200 pt-5 pb-4 bg-gray-100">
        ...
        <div class="h-0 flex-1 flex flex-col overflow-y-auto">
          ...
          <div class="px-3 mt-6 relative inline-block text-left">
            ...
            >
              <div v-show="menuToggle" class="z-10 mx-3 origin-top absolute right-0 left-0 mt-1 rounded-md shadow-lg">
    ...
    <div class="flex flex-col w-0 flex-1 overflow-hidden">
      ...
      <div class="relative z-10 flex-shrink-0 flex h-16 bg-white border-b border-gray-200 lg:hidden">
        ...
        <button @click="sideToggle = !sideToggle" class="px-4 border-r border-gray-200 text-gray-500 cursor-pointer focus:outline-none focus:bg-gray-100 focus:text-gray-600 lg:hidden" aria-label="Open sidebar">
        ...
        <div class="flex-1 flex justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div class="flex items-center">
            ...
            <div class="ml-3 relative">
              <div>
                <button @click="menuToggle = !menuToggle" class="max-w-xs flex items-center text-sm rounded-full focus:outline-none focus:shadow-outline" id="user-menu" aria-label="User menu" aria-haspopup="true">
              ...
              <transition
                ...
                leave-to-class="transform opacity-0 scale-95"
              >
                <div v-show="menuToggle" class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg">
